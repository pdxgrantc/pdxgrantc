        ...
        return (
            <>
                <div className='bg-dark_grey flex justify-between'>
                    <Link className="leading-[5rem] w-[35vw] bg-black pl-[5vw] h-[8.5vh] text-[3.75rem] font-bold hover:cursor-pointer mobile:text-4xl on_desktop:whitespace-nowrap" to="/">Grant Conklin</Link>
