        ...
        return (
            <>
                <div className='bg-dark_grey flex justify-between h-[10vh]'>
                    <Link className="h-full leading-[5rem] w-[35vw] bg-black pl-[5vw] text-[3.75rem] font-bold hover:cursor-pointer mobile:text-4xl on_desktop:whitespace-nowrap" to="/">Grant Conklin</Link>
