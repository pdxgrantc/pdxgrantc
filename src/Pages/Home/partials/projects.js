                    ...
                    <div className="flex on_mobile:flex-col gap-[10vw] mt-[2vh] text-4xl">
                        <div className="text-[2.75rem]">
                            <div className="on_mobile:pb-3">
                                ...
                                <h6 className="pt-[.75rem] text-[1.65rem] on_mobile:leading-[2rem]">I was tasked to create a terminal similar to bash with multi-process and background capability. The terminal allows linux binarys to be called from the bin directory. THe input has error checking and was developed entirely in the C language.</h6>
                            </div>
                        </div>
                        <div className="text-[2.75rem]">
                            <div className="on_mobile:pb-3">
