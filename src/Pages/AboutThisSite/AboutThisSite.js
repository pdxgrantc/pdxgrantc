    ...
    return (
        <>
            ...
            <div className="m-auto bg-main_bg_color text-text_white">
                ...
                <div className=" m-auto on_desktop:flex on_desktop:flex-col on_desktop:gap-[3vh] on_desktop:px-[3vw] on_desktop:bg-black">
                        ...
                        <div >
                            ...
                            <div className="flex flex-col gap-5">
                                <div className="on_mobile:hidden on_desktop:gap-[2vw] w-[100%] flex justify-between bg-black">
                                    <img className="m-auto w-auto h-[43vh]" src={HomeScreeenshot} alt="HomePage"></img>
                                ...
                                <div className="w-[100%] flex on_desktop:gap-[2vw] justify-between on_mobile:flex-col bg-black">
                                    ...
                                    <div className="flex flex-col justify-center gap-5">
                                        ...
                                        <h3 className="align-middle leading-[1.1] text-[2.5rem] text-wrap">I chose React to develop this site for the ease of getting a modern, responsive, and scalable user interface. For the visual design and layout of the project I used Tailwind to simplify the CSS implementation and allow for a cleaner development package.</h3>
