    ...
    return (
        <>
            ...
            <div class="m-auto bg-main_bg_color text-text_white">
                ...
                <div class="on_desktop:flex on_desktop:gap-[3vh] on_desktop:px-[3vw] on_desktop:py-[4vh] on_desktop:flex-col on_desktop:bg-black m-auto on_mobile:mx-auto on_mobile:w-[90vw] on_mobile:py-[4vh] on_mobile:bg-black">
